...
In my work, I strive to create user-friendly and functional web applications with flexible design and high performance. I use advanced tools and technologies to streamline the development process and improve the user experience.
...
- HTML5, CSS3
- PUG, SASS, LESS
- JavaScript ES6, jQuery, TypeScript, PHP, Python, Node.js
- CMS (Wordpress, OpenCart, 1C Bitrix, Drupal, Joomla)
